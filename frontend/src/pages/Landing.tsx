...
export default function Landing() {
  return (
    <div className="min-h-screen bg-bg">
      {/* Nav */}
      <nav className="flex items-center justify-between gap-4 border-b border-border bg-bg px-6 py-4 md:px-10">
        <Link to="/" aria-label="Applify home">
          <Logo size={36} />
        </Link>
        ...
        <Link
          to="/signup"
          className="rounded-input bg-coral px-5 py-2.5 text-[14px] font-medium text-white transition-opacity hover:opacity-90"
        >
          Get started free
        </Link>
      </nav>
      ...
      {/* Hero */}
      <header className="mx-auto max-w-hero px-6 pb-14 pt-16 text-center md:pt-[72px]">
        ...
        <h1 className="font-serif text-[32px] font-medium leading-tight text-teal-ink md:text-hero">
          Apply smarter.
          <br />
      ...
      {/* Product mockup */}
      <section className="mx-6 mb-14 overflow-hidden rounded-panel border border-border bg-card md:mx-10">
        ...
        <div className="grid min-h-[260px] grid-cols-1 sm:grid-cols-[200px_1fr]">
          <div className="border-b border-border bg-surface py-4 sm:border-b-0 sm:border-r">
            ...
            <div className="border-l-2 border-teal-deep bg-teal-light px-4 py-2.5 text-[12px] font-medium text-teal-ink">
              ...
              <div className="mt-0.5 text-[10px] font-normal text-teal-deep/70">
                Stripe
              </div>
            </div>
            <div className="border-l-2 border-transparent px-4 py-2.5 text-[12px] text-text-muted">
              AI Engineer
              <div className="mt-0.5 text-[10px] text-text-faint">Anthropic</div>
            </div>
            <div className="border-l-2 border-transparent px-4 py-2.5 text-[12px] text-text-muted">
              Full Stack Engineer
              <div className="mt-0.5 text-[10px] text-text-faint">Linear</div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 px-5 py-5 md:px-6">
            ...
            <div className="max-w-[80%] rounded-box rounded-bl-[2px] bg-surface-warm px-3.5 py-2.5 text-[12px] leading-relaxed text-text-primary">
      ...
      {/* Features */}
      <section id="features" className="px-6 pb-14 md:px-10">
      ...
      {/* How it works */}
      <section id="how-it-works" className="bg-surface-warm px-6 py-12 md:px-10">
      ...
      {/* Footer */}
      <footer className="flex flex-col items-center justify-between gap-3 border-t border-border px-6 py-5 sm:flex-row md:px-10">
        <span className="text-[12px] text-text-muted">
          © 2025 Applify. All rights reserved.
        </span>
        <div className="flex gap-5">
          <a href="#" className="text-[12px] text-text-muted hover:text-teal-deep">
            Privacy
          </a>
          <a href="#" className="text-[12px] text-text-muted hover:text-teal-deep">
            Terms
